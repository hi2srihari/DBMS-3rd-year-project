...
?>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul>
							...
							<li><a href="1artists.phpl">Artist info</a><a href="twocolumn1.html"></a></li>
    ...
    // output data of each row
								while($row = mysqli_fetch_assoc($result)) { echo "<h1>Name: " . $row["name"] ."</h1>"; ?>
							</header>
							
							<p><?php

							echo '<img height=200 width=200 src="data:image/jpeg;base64,'.base64_encode( $row['photo'] ).'"/>';
							echo "<p>-DOB: " . $row["dob"]. ", Born at: ". $row["hometown"]."</p><p> " . " - Gender: " . $row["gender"]. "</p><p>-Marital Status  " . $row["marital_status"]. " </p><p>-Most famous for:" . $row["famous_for"] ."</p><br>";
						}
					} else {
						echo "0 results";
					}
